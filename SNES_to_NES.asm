...
MAIN:
	RCALL SNES_READ
	MOV NES, SNES_LOW	;MOST BITS ARE THE SAME IN NES AND SNES
	ANDI NES, 0B11111100	;BUT THE LOW 2 BITS ARE DIFFERENT
	SBRC SNES_HIGH, 0	;CHECK BIT 0 IN SNES HIGH
	ORI NES, 0B00000001	;IF BIT 0 IN SNES IS SET THEN SET BIT 0 IN NES
	SBRC SNES_LOW, 0
	ORI NES, 0B00000010	;IF BIT 0 IN SNES LOW IS SET THEN SET BIT 1 IN NES
	EOR NES, MASK	;MODIFY A AND B
	...
	ANDI NES, 0b11111110	;IF LEFT BUTTON IS PRESSED THEN PRESS BUTTON A IN NES
	INC READ_COUNT
	;CPI READ_COUNT, 0x80
	;BRNE M_NO_RESET
	;CLR READ_COUNT
